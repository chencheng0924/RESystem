...
import { UILayout, UILayoutController } from '../Core/UILayoutController';
import PopupDrawer from '../CPopupDrawer/PopupDrawer.vue';
...
<template>
  <div class="w-screen h-screen flex flex-col overflow-hidden">   
    <div class="flex flex-grow overflow-hidden">
      ...
      <div class="flex-1 overflow-auto h-full !bg-foneBg"
        :class="{ '!pt-[0px]':menuStore.isMenuCollapsed , '!pt-[68px]':!menuStore.isMenuCollapsed  }"
      >
    ...
    <Drawer :dismissible="controller.template.DrawerViewRef.value.IsDismissible" :pt="pt"
            ...
            :modal="controller.template.DrawerViewRef.value.IsMode" 
            :position="controller.template.DrawerViewRef.value.IsFullWidth ? 'full' : 'right'"
            :header="controller.template.DrawerViewRef.value.DrawerSection.Title" >
            <template #header>
