...
const storedConfig = localStore.getTheme();
...
const primaryColors = ref([
    ...
    { name: 'testPurple', palette: { 50: '#F5F3FE', 100: '#EAE6FD', 200: '#D6CEFB', 300: '#C1B5F9', 400: '#4C37CD', 500: '#3E2CAA', 600: '#302287', 700: '#231964', 800: '#161141', 900: '#0A081E', 950: '#05040F' } },
]);
...
export function useLayout() {
    ...
    return {
        primaryColors, surfaces, layoutConfig: readonly(layoutConfig), layoutState: readonly(layoutState), onMenuToggle, isSidebarActive, isDarkTheme, getPrimary, getSurface, setActiveMenuItem, toggleDarkMode, setPrimary, setSurface, setPreset, resetMenu, setMenuMode
    };
}
