...
<template>
    ...
    <svg v-if="name === 'update'" width="24" height="24" viewBox="0 0 24 24">
        <path
    ...
    <svg v-if="name === 'sun'" width="24" height="24" viewBox="0 0 24 24">
        <path
    ...
    <svg v-if="name === 'moon'" width="24" height="24" viewBox="0 0 24 24">
        <path
    ...
    <svg v-if="name === 'log'" width="24" height="24" viewBox="0 0 24 24">
        <path
